        ...
        <div class="app-sidebar">
            ...
            <div class="app-menu">
                <ul class="accordion-menu">
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>service"><i class="material-icons-two-tone">dns</i>Cek Layanan</a>
                    </li>

                    <li class="has_sub">
                        <a href=""><i class="material-icons-two-tone">receipt</i>Invoice<i class="material-icons has-sub-menu">keyboard_arrow_right</i></a>
                        <ul class="sub-menu">
                            <li><a href="<?php echo base_url(); ?>invoice">Data Invoice</a></li>
                            <li><a href="<?php echo base_url(); ?>invoice/list">Lihat semua data</a></li>
                        </ul>
                    </li>


                    <li>
                        <a href="<?php echo base_url(); ?>ticket"><i class="material-icons-two-tone">email</i>Tiket</a>
                    </li>
                    ...
                    <li class="has_sub">
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a href="<?php echo base_url(); ?>account/index/<?php echo $this->session->userdata('id') ?>">Akun</a>
                            </li>
